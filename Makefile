...
c: openportd
	$${x} ./openportd s.active=no c.active=yes --debug=$${z} c.ports=22,80 c.port=localhost:40001

cc: openportd
	$${x} ./openportd s.active=no c.active=yes --debug=$${z} c.ports=22,80 c.port=mp:40001
